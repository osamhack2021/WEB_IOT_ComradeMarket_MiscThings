...
<?php
    ...
    $search = prevent_sqli($search);
    
    $sqlCount = "SELECT count(*) FROM product WHERE title LIKE " . '"%' . $search . '%"';
    ...
    $sql = "SELECT articleid, title, body, price, category, place_sell, saleway, imagepath, uploadtime, id, belong, city, status FROM product WHERE title LIKE " . '"%'. $search . '%"' . " ORDER BY uploadtime desc limit ".$beginIdx.",".$pageSize."";
                ...
                -->
                        ...
                        <?php	
                            ...
                            if($startPage >= $pageListSize) {	
                                ...
                                echo "<li class=\"page-item\"><a class=\"page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0\" href=\"$PHP_SELF?no=$prevList$PHP_SELF&search=$search\" aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>";	
                            }	
                            for ($i = $startPage; $i <= $endPage; $i++) {	
                                ...
                                if ($no == $pageNum) {	
                                    echo "<li class=\"page-item active\"><a class=\"page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0\" href=\"$PHP_SELF?no=$pageNum$PHP_SELF&search=$search\">";	
                                }	
                                else if ($no != $pageNum) {	
                                    echo "<li class=\"page-item\"><a class=\"page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0\" href=\"$PHP_SELF?no=$pageNum$PHP_SELF&search=$search\">";	
                                }	
                                echo $pageNum;	
                                echo "</a></li>";	
                            }	
                            if ($totalPage > $endPage) {	
                                $nextList = $endPage + 1;	
                                echo "<li class=\"page-item\"><a class=\"page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0\" href=\"$PHP_SELF?no=$nextList$PHP_SELF&search=$search\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li>";	
                            }	
