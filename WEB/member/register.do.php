...
<?php
    ...
    prevent_sqli($phone), prevent_sqli($belong),prevent_sqli($office), prevent_sqli($officePhone), $admin);

    $query = "INSERT INTO member(`name`, `id`, `serialnumber`, `password`, `email`, `phone`, `belong`,`office`,
    `officePhone`, `admin`) VALUES ('{$safe_var[0]}', '{$safe_var[1]}', '{$safe_var[2]}', '{$safe_var[3]}', '{$safe_var[4]}', '{$safe_var[5]}', '{$safe_var[6]}', '{$safe_var[7]}',
    '{$safe_var[8]}','{$safe_var[9]}')";
