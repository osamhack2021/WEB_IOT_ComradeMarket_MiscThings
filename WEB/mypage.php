            ...
            <form class="col-md-9 m-auto" method="POST" role="form">
                <div class="row pb-3">
                    <div class="col d-grid">
                        <button type="submit" class="btn btn-success btn-lg" onclick = "location.href = ''; "> 내가 구매한 물건 </button>
                    </div>
                    <div class="col d-grid">
                        <button type="button" class="btn btn-success btn-lg" onclick = "location.href = ''; "> 내가 판매한 물건 </button>
                    </div>
                    <div class="col d-grid">
                        <button type="button" class="btn btn-success btn-lg" onclick = "location.href = ''; "> 쪽지함 </button>
                    </div>
                </div>
            </form>
            <form class="col-md-9 m-auto" method="POST" role="form">
