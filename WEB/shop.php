...
<?php
    ...
    $sql = "SELECT articleid, title, body, price, category, place_sell, saleway, imagepath, uploadtime, id, belong, city FROM product ORDER BY uploadtime desc limit ".$beginIdx.",".$pageSize."";
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            ...
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">마이페이지</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">마이페이지</a>
                            </li>
                    ...
                    <div class="col-md-6 pb-4">
                        <div class="d-flex">
                            <form class="d-md-inline-block form-inline navbar-search col-xl-7" action="search_product.do.php" method="POST">
                                    <input class="form-control input-lg bg-white border-1" onkeyup="enterkey();" name="search" placeholder="어떤 물건을 찾고 계신가요?" aria-label="Search" aria-describedby="basic-addon2">
                            </form>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card rounded-0">
                                    ...
                                    <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                        <ul class="list-unstyled">
                                            <li><a class="btn btn-success text-white mt-2" href="shop-contents.php' . $row["articleid"] .'"><i class="far fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="card-body">
